...
void gmtime_test(const char *name,
...
START_TEST(test_gps_time_match_weeks)
{
  struct gps_time_match_weeks_testcase {
    ...
    {.t = {DAY_SECS, WN_UNKNOWN}, .ref = {2*DAY_SECS, WN_UNKNOWN}, .ret = {DAY_SECS, WN_UNKNOWN}},
    {.t = {DAY_SECS, WN_UNKNOWN}, .ref = {6*DAY_SECS, WN_UNKNOWN}, .ret = {DAY_SECS, WN_UNKNOWN}},
  };
  for (size_t i = 0;
...
START_TEST(test_glo2gps)
{
  ...
  for (size_t i = 0;
       i < sizeof(testcases) / sizeof(struct glo2gps_testcase);
       i++) {
    ...
    fail_unless(ret.wn == testcases[i].ret.wn &&
                ...
                i, ret.wn, ret.tow, testcases[i].ret.wn, testcases[i].ret.tow);
    if (gps_time_valid(&ret)) {
      /* convert back to GLO time */
      glo_time_t glo = gps2glo(&ret, NULL);
      fail_unless(glo.n4 == testcases[i].glot.n4 &&
                  glo.nt == testcases[i].glot.nt &&
                  glo.h == testcases[i].glot.h &&
                  glo.m == testcases[i].glot.m &&
                  within_epsilon(glo.s, testcases[i].glot.s),
                  "gps2glo test case %d failed, got (%d,%d,%d,%d,%f), expected (%d,%d,%d,%d,%f)",
                  i, glo.n4, glo.nt, glo.h, glo.m, glo.s,
                  testcases[i].glot.n4, testcases[i].glot.nt, testcases[i].glot.h,
                  testcases[i].glot.m, testcases[i].glot.s);
    }
...
START_TEST(test_utc_offset)
{
  ...
  for (size_t i = 0;
       i < sizeof(testcases) / sizeof(struct utc_offset_testcase);
       i++) {
    double dUTC = get_gps_utc_offset(&testcases[i].t, NULL);
    double is_lse = is_leap_second_event(&testcases[i].t, NULL);

    fail_unless(dUTC == testcases[i].dUTC &&
                is_lse == testcases[i].is_lse,
                "utc_leap_testcase %d failed, expected (%f,%d) got (%f,%d)",
                i, testcases[i].dUTC, testcases[i].is_lse, dUTC, is_lse);
    ...
    if (!is_lse) {
      gps_time_t utc_time = {.wn=testcases[i].t.wn, .tow=testcases[i].t.tow - dUTC};
...
static utc_params_t p_neg_offset = {
    .a0 = -0.125, .a1 = 0.0,
    .tot.wn = 2080, .tot.tow = 0,
    .t_lse.wn = 2086, .t_lse.tow = 259218.0 - 0.125,
    .dt_ls = 18, .dt_lsf = 19
};
static utc_params_t p_pos_offset = {
    .a0 = +0.125, .a1 = 0.0,
    .tot.wn = 2080, .tot.tow = 0,
    .t_lse.wn = 2086, .t_lse.tow = 259218.0 + 0.125,
    .dt_ls = 18, .dt_lsf = 19
...
static utc_params_t p_pos_trend = {
    .a0 = 0, .a1 = 1e-12,
    .tot.wn = 2080, .tot.tow = 0,
    .t_lse.wn = 2086, .t_lse.tow = 259218.0 + 1e-12*(6*WEEK_SECS + 259218.0),
    .dt_ls = 18, .dt_lsf = 19
};
...
START_TEST(test_utc_params)
{
  ...
  struct utc_params_testcase {
    ...
    utc_params_t *p;
      ...
      {.t = {.wn=2086, .tow=259217.0-0.125}, .dUTC = 18.0-0.125, .is_lse = false, .p = &p_neg_offset},
      {.t = {.wn=2086, .tow=259217.5-0.125}, .dUTC = 18.0-0.125, .is_lse = false, .p = &p_neg_offset},
      {.t = {.wn=2086, .tow=259218.0-0.125}, .dUTC = 18.0-0.125, .is_lse = true,  .p = &p_neg_offset},
      {.t = {.wn=2086, .tow=259218.5-0.125}, .dUTC = 18.0-0.125, .is_lse = true,  .p = &p_neg_offset},
      {.t = {.wn=2086, .tow=259219.0-0.125}, .dUTC = 19.0-0.125, .is_lse = false, .p = &p_neg_offset},
      {.t = {.wn=2086, .tow=259219.5-0.125}, .dUTC = 19.0-0.125, .is_lse = false, .p = &p_neg_offset},
      /* Jan 1 2020 (constant positive UTC offset) */
      {.t = {.wn=2086, .tow=259217.0+0.125}, .dUTC = 18.0+0.125, .is_lse = false, .p = &p_pos_offset},
      {.t = {.wn=2086, .tow=259217.5+0.125}, .dUTC = 18.0+0.125, .is_lse = false, .p = &p_pos_offset},
      {.t = {.wn=2086, .tow=259218.0+0.125}, .dUTC = 18.0+0.125, .is_lse = true,  .p = &p_pos_offset},
      {.t = {.wn=2086, .tow=259218.5+0.125}, .dUTC = 18.0+0.125, .is_lse = true,  .p = &p_pos_offset},
      {.t = {.wn=2086, .tow=259219.0+0.125}, .dUTC = 19.0+0.125, .is_lse = false, .p = &p_pos_offset},
      {.t = {.wn=2086, .tow=259219.5+0.125}, .dUTC = 19.0+0.125, .is_lse = false, .p = &p_pos_offset},
      /* Jan 1 2020 (positive UTC linear correction) */
      {.t = {.wn=2086, .tow=259217.0}, .dUTC = 18.0, .is_lse = false, .p = &p_pos_trend},
      {.t = {.wn=2086, .tow=259217.5}, .dUTC = 18.0, .is_lse = false, .p = &p_pos_trend},
      {.t = {.wn=2086, .tow=259218.0001}, .dUTC = 18.0, .is_lse = true,  .p = &p_pos_trend},
      {.t = {.wn=2086, .tow=259218.5}, .dUTC = 18.0, .is_lse = true,  .p = &p_pos_trend},
      {.t = {.wn=2086, .tow=259219.0001}, .dUTC = 19.0, .is_lse = false, .p = &p_pos_trend},
      {.t = {.wn=2086, .tow=259219.5}, .dUTC = 19.0, .is_lse = false, .p = &p_pos_trend},
      /* Jan 1 2020 (negative UTC linear correction) */
      {.t = {.wn=2086, .tow=259217.0}, .dUTC = 18.0, .is_lse = false, .p = &p_neg_trend},
      {.t = {.wn=2086, .tow=259217.5}, .dUTC = 18.0, .is_lse = false, .p = &p_neg_trend},
      {.t = {.wn=2086, .tow=259218.0}, .dUTC = 18.0, .is_lse = true,  .p = &p_neg_trend},
      {.t = {.wn=2086, .tow=259218.5}, .dUTC = 18.0, .is_lse = true,  .p = &p_neg_trend},
      {.t = {.wn=2086, .tow=259219.0}, .dUTC = 19.0, .is_lse = false, .p = &p_neg_trend},
      {.t = {.wn=2086, .tow=259219.5}, .dUTC = 19.0, .is_lse = false, .p = &p_neg_trend},
  };
  for (size_t i = 0;
       i < sizeof(testcases) / sizeof(struct utc_params_testcase);
       i++) {
    ...
    if (!is_lse) {
      ...
      fail_unless(within_epsilon(dGPS, -testcases[i].dUTC),
    ...
    fail_unless(fabs(gpsdifftime(&testcases[i].t, &converted)) < 1e-5,
        "utc_params_testcase %d gps2glo2gps failed for (%u/%u %u:%u:%.16f), "
        "expected (%d, %f), got (%d, %f)",
        i, glo_time.n4, glo_time.nt, glo_time.h, glo_time.m, glo_time.s,
        testcases[i].t.wn, testcases[i].t.tow, converted.wn, converted.tow);
  }
}
END_TEST
...
START_TEST(test_gps2utc)
{
  ...
  struct gps2utc_testcase {
    ...
    utc_params_t *p;
      ...
      /* July 1 1981 */
      {.t = {.wn=77, .tow=259199.0}, .u = {.year=1981, .month=6, .month_day=30, .hour=23, .minute=59, .second_int=59, .second_frac=0.0}, .p = NULL},
      {.t = {.wn=77, .tow=259199.5}, .u = {.year=1981, .month=6, .month_day=30, .hour=23, .minute=59, .second_int=59, .second_frac=0.5}, .p = NULL},
      {.t = {.wn=77, .tow=259200.0}, .u = {.year=1981, .month=6, .month_day=30, .hour=23, .minute=59, .second_int=60, .second_frac=0.0}, .p = NULL},
      {.t = {.wn=77, .tow=259200.5}, .u = {.year=1981, .month=6, .month_day=30, .hour=23, .minute=59, .second_int=60, .second_frac=0.5}, .p = NULL},
      {.t = {.wn=77, .tow=259201.0}, .u = {.year=1981, .month=7, .month_day=01, .hour=00, .minute=00, .second_int=00, .second_frac=0.0}, .p = NULL},
      /* Jan 1 2017 */
      {.t = {.wn=1930, .tow=16.0}, .u = {.year=2016, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.0}, .p = NULL},
      {.t = {.wn=1930, .tow=16.5}, .u = {.year=2016, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.5}, .p = NULL},
      {.t = {.wn=1930, .tow=17.0}, .u = {.year=2016, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.0}, .p = NULL},
      {.t = {.wn=1930, .tow=17.5}, .u = {.year=2016, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.5}, .p = NULL},
      {.t = {.wn=1930, .tow=18.0}, .u = {.year=2017, .month=01, .month_day=01, .hour=00, .minute=00, .second_int=00, .second_frac=0.0}, .p = NULL},
      /* Jan 8 2017 */
      {.t = {.wn=1931, .tow=17.0}, .u = {.year=2017, .month=01, .month_day=7, .hour=23, .minute=59, .second_int=59, .second_frac=0.0}, .p = NULL},
      {.t = {.wn=1931, .tow=17.5}, .u = {.year=2017, .month=01, .month_day=7, .hour=23, .minute=59, .second_int=59, .second_frac=0.5}, .p = NULL},
      {.t = {.wn=1931, .tow=18 - 6e-11}, .u = {.year=2017, .month=01, .month_day=7, .hour=23, .minute=59, .second_int=59, .second_frac=1 - 6e-11}, .p = NULL},
      {.t = {.wn=1931, .tow=18 - 5e-11}, .u = {.year=2017, .month=01, .month_day=8, .hour=00, .minute=00, .second_int=00, .second_frac=0.0}, .p = NULL},
      {.t = {.wn=1931, .tow=18.0}, .u = {.year=2017, .month=01, .month_day=8, .hour=00, .minute=00, .second_int=00, .second_frac=0.0}, .p = NULL},
      /* Jan 1 2020 (leap second announced in utc_params_t above, constant negative offset) */
      {.t = {.wn=2086, .tow=259217.0-0.125}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.0}, .p = &p_neg_offset},
      {.t = {.wn=2086, .tow=259217.5-0.125}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.5}, .p = &p_neg_offset},
      {.t = {.wn=2086, .tow=259218.0-0.125}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.0}, .p = &p_neg_offset},
      {.t = {.wn=2086, .tow=259218.5-0.125}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.5}, .p = &p_neg_offset},
      {.t = {.wn=2086, .tow=259219.0-0.125}, .u = {.year=2020, .month=01, .month_day=01, .hour=00, .minute=00, .second_int=00, .second_frac=0.0}, .p = &p_neg_offset},
      /* Jan 1 2020 (leap second announced in utc_params_t above, constant positive offset) */
      {.t = {.wn=2086, .tow=259217.0+0.125}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.0}, .p = &p_pos_offset},
      {.t = {.wn=2086, .tow=259217.5+0.125}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.5}, .p = &p_pos_offset},
      {.t = {.wn=2086, .tow=259218.0+0.125}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.0}, .p = &p_pos_offset},
      {.t = {.wn=2086, .tow=259218.5+0.125}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.5}, .p = &p_pos_offset},
      {.t = {.wn=2086, .tow=259219.0+0.125}, .u = {.year=2020, .month=01, .month_day=01, .hour=00, .minute=00, .second_int=00, .second_frac=0.0}, .p = &p_pos_offset},
      /* Jan 1 2020 (leap second announced in utc_params_t above, positive UTC linear correction) */
      {.t = {.wn=2086, .tow=259217.0}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.0}, .p = &p_pos_trend},
      {.t = {.wn=2086, .tow=259217.5}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.5}, .p = &p_pos_trend},
      {.t = {.wn=2086, .tow=259218.0}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.0}, .p = &p_pos_trend},
      {.t = {.wn=2086, .tow=259218.5}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.5}, .p = &p_pos_trend},
      {.t = {.wn=2086, .tow=259219.00001}, .u = {.year=2020, .month=01, .month_day=01, .hour=00, .minute=00, .second_int=00, .second_frac=0.0}, .p = &p_pos_trend},
      /* Jan 1 2020 (leap second announced in utc_params_t above, negative UTC linear correction) */
      {.t = {.wn=2086, .tow=259217.0}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.0}, .p = &p_neg_trend},
      {.t = {.wn=2086, .tow=259217.5}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=59, .second_frac=0.5}, .p = &p_neg_trend},
      {.t = {.wn=2086, .tow=259218.0}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.0}, .p = &p_neg_trend},
      {.t = {.wn=2086, .tow=259218.5}, .u = {.year=2019, .month=12, .month_day=31, .hour=23, .minute=59, .second_int=60, .second_frac=0.5}, .p = &p_neg_trend},
      {.t = {.wn=2086, .tow=259219.0}, .u = {.year=2020, .month=01, .month_day=01, .hour=00, .minute=00, .second_int=00, .second_frac=0.0}, .p = &p_neg_trend},
  };

  utc_tm u;
  for (size_t i = 0;
       i < sizeof(testcases) / sizeof(struct gps2utc_testcase);
       i++) {
